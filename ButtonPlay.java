...
/**
 * ButtonPlay is the subclass of Button that contains a sound as well as
...
public class ButtonPlay extends Button
{
    ...
    /**
     * Main constructor for the ButtonPlay class. ButtonPlay is the subclass of Button that 
     ...
     */
    public ButtonPlay(double plantHealth, double plantDamage, double plantAttackSpeed, double zombieHealth, double zombieSpeed, double zombieDamage)
    {
        super();
    ...
    public void act()
    {
        ...
        {
            Greenfoot.setWorld (new ZombieWorld(plantHealth, plantDamage, plantAttackSpeed, zombieHealth, zombieSpeed, zombieDamage));
        }
    }
}